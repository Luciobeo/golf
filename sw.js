const CACHE='andrea-golf-caddie-v2-0-0';
const ASSETS=["./", "./index.html", "./manifest.webmanifest", "./icon-192.png", "./icon-512.png", "./assets/home-montecchia.jpg", "./assets/montecchia-bianco.jpg", "./assets/montecchia-rosso.jpg", "./assets/montecchia-verde.jpg"];
